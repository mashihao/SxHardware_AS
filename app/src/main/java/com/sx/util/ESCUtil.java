...
public class ESCUtil {
    ...
    public static final byte LF = 0x0A;// Print and wrap (horizontal
    // orientation)
    public static final byte CR = 0x0D;// Home key
    public static final byte FF = 0x0C;// Carriage control (print and return to
    // the standard mode (in page mode))
    public static final byte CAN = 0x18;// Canceled (cancel print data in page
    // mode)
     ...
     * @param errorlevel : 二维码纠错等级(0 至 3) 0 -- 纠错级别L ( 7%) 1 -- 纠错级别M (15%) 2 -- 纠错级别Q (25%) 3 -- 纠错级别H (30%)
     */
     ...
     * @param code2      : 二维码数据
     * @param modulesize : 二维码块大小(单位:点, 取值 1 至 16 )
     * @param errorlevel : 二维码纠错等级(0 至 3) 0 -- 纠错级别L ( 7%) 1 -- 纠错级别M (15%) 2 -- 纠错级别Q
     *                   (25%) 3 -- 纠错级别H (30%)
     */
